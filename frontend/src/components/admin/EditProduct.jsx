...
export default function EditProduct(prodId) {
  ...
  const handleClickOpen = () => {
      ...
      let selectedProd = items.filter((item) => item._id === prodId.prodId );
...
const StyledEditProduct = styled.div`
  ...
  max-width: 800px;  // Add a max-width to limit the width of the form and preview
  margin: auto;      // Center the form and preview
`;
